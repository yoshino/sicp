...
(define (make-new-machine)
  (let ((pc (make-register 'pc))     ;Program Counter
        ...
        (the-initial-instruction-sequence '()))
    (let ((the-ops
      ...
      (define (dispatch message)
        (cond ((eq? message 'start)
              ...
              ((eq? message 'install-instruction-sequence)
               (lambda (seq)
                 (set! the-initial-instruction-sequence seq)
              ...
              ((eq? message 'orders) (show-orders the-initial-instruction-sequence))
...
;;INFO
;;--------------------------------------------------------
(define (orders machine) (machine 'orders))
(define (show-orders insts) insts)
